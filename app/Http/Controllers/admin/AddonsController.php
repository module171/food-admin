...
class AddonsController extends Controller
{
    ...
    {
        $getaddons = Addons::where('is_available','1')->get();
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $addons = new Addons;
            $addons->cat_id =htmlspecialchars($request->cat_id, ENT_QUOTES, 'UTF-8');
            $addons->item_id =htmlspecialchars($request->item_id, ENT_QUOTES, 'UTF-8');
            $addons->name =htmlspecialchars($request->name, ENT_QUOTES, 'UTF-8');
            $addons->price =htmlspecialchars($price, ENT_QUOTES, 'UTF-8');
            $addons->save();
